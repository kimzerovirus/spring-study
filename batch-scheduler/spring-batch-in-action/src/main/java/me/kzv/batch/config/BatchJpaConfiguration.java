...
import static me.kzv.batch.config.BatchJpaConfiguration.MASTER_ENTITY_MANAGER_FACTORY;
import static me.kzv.batch.config.BatchJpaConfiguration.MASTER_TX_MANAGER;
import static me.kzv.batch.config.BatchJpaConfiguration.PACKAGE;
...
public class BatchJpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean readerEntityManagerFactory(
            @Qualifier(DataSourceConfiguration.READER_DATASOURCE) DataSource dataSource) {
