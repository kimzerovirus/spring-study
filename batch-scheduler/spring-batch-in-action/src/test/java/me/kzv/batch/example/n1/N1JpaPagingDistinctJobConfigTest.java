...
@SpringBatchTest
@SpringBootTest(classes = {N1JpaPagingDistinctJobConfig.class, TestBatchConfig.class})
class N1JpaPagingDistinctJobConfigTest {
    ...
    @Test
    void JPA_FETCH_JOIN_test() throws Exception {
        //given
        for(long i=1;i<=10;i++) {
