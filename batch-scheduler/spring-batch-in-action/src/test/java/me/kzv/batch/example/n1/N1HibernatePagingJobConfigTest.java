package me.kzv.batch.example.n1;
...
@SpringBatchTest
@SpringBootTest(classes = {N1HibernatePagingJobConfig.class, TestBatchConfig.class})
class N1HibernatePagingJobConfigTest {
    ...
    @Test
    void HibernatePaging_batch_size_test() throws Exception {
        //given
        for(long i=1;i<=10;i++) {
