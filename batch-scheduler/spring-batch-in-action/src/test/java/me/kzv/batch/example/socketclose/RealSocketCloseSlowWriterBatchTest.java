...
@SpringBootTest(classes = {TestBatchConfig.class, SocketCloseSlowWriterBatch.class})
@SpringBatchTest
@ActiveProfiles(profiles = "real")
public class RealSocketCloseSlowWriterBatchTest {
    ...
    @Test
    public void writer가_DB를_사용하지않아도_실패한다() throws Exception {
        //given
