...
//        }
        ...
        return QItem.item.regTime.after(dateTime); // 해당 등록시간 이후 등록된 것들
    }
    ...
    public Page<MainItemDto> getMainItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        ...
        QMainItemDto qMainItemDto = new QMainItemDto(item.id, item.itemNm, item.itemDetail, itemImg.imgUrl, item.price);
