package me.kzv.boardapi.config;

import lombok.RequiredArgsConstructor;
import me.kzv.boardapi.security.exception.CustomAuthenticationEntryPoint;
import me.kzv.boardapi.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .addFilterBefore(new JwtAuthenticationFilter(tokenProvider), UsernamePasswordAuthenticationFilter.class); // jwt token 필터를 id/password 인증 필터 전에 넣어라.
    }
