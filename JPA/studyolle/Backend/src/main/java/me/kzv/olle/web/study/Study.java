...
import me.kzv.olle.web.account.UserAccount;
import me.kzv.olle.web.tag.Tag;
import me.kzv.olle.web.zone.Zone;
...
public class Study {
    ...
    public String getImage(Account account){
    ...
    public void publish(){
        if (!this.closed && !this.published) {
            ...
            throw new RuntimeException("스터디를 공개할 수 없는 상태입니다. 스터디를 이미공개했거나 종료했습니다.");
        }
    }
