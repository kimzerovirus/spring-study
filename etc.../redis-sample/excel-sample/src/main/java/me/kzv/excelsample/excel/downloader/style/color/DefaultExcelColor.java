...
import me.kzv.excelsample.exception.UnSupportedExcelTypeException;
...
public class DefaultExcelColor implements ExcelColor {
    ...
    public static DefaultExcelColor rgb(ExcelColorTable colorTable){
        return rgb(colorTable.getRed(), colorTable.getGreen(), colorTable.getBlue());
    }
